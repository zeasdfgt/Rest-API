package ca.ulaval.glo4002.reservation.reports.chef.rest.mappers;
...
@Provider
public class NoPossibleChefExceptionMapper implements ExceptionMapper<NoPossibleChefException> {
  ...
  @Override
  public Response toResponse(NoPossibleChefException noPossibleChefException) {
