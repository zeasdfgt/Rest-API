...
@Provider
public class AllergyConflictExceptionMapper implements ExceptionMapper<AllergyConflictException> {
  ...
  @Override
  public Response toResponse(AllergyConflictException allergyConflictException) {
